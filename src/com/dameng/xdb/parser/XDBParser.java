...
public class XDBParser extends Parser {
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(43); ((StmtContext)_localctx).se_stmt = se_stmt();
	...
	public final Se_stmtContext se_stmt() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(48); match(KW_LOGIN);
				setState(49); ((Se_stmtContext)_localctx).host = host();
				setState(50); match(T__4);
				setState(51); ((Se_stmtContext)_localctx).port = port();
				setState(52); end();
			...
			case 3:
				...
				{
				setState(55); match(KW_LOGIN);
				setState(56); ((Se_stmtContext)_localctx).host = host();
				setState(57); match(T__4);
				setState(58); ((Se_stmtContext)_localctx).port = port();
				setState(59); match(T__7);
				setState(60); ((Se_stmtContext)_localctx).user = identifier();
				setState(61); match(T__8);
				setState(62); ((Se_stmtContext)_localctx).password = identifier();
				setState(63); end();
			...
			case 7:
				...
				{
				setState(72); match(KW_PUT);
				setState(73); match(KW_NODE);
				setState(74); match(T__6);
				setState(75); ((Se_stmtContext)_localctx).categorys = categorys();
				setState(76); match(T__5);
				setState(77); match(T__2);
				setState(78); ((Se_stmtContext)_localctx).properties = properties();
			...
			case 8:
				...
				{
				setState(83); match(KW_PUT);
				setState(84); match(KW_LINK);
				setState(85); match(T__6);
				setState(86); ((Se_stmtContext)_localctx).fnode = obj_id();
				setState(87); match(T__1);
				setState(88); ((Se_stmtContext)_localctx).tnode = obj_id();
				setState(89); match(T__1);
				setState(90); ((Se_stmtContext)_localctx).categorys = categorys();
				setState(91); match(T__5);
				setState(92); match(T__2);
				setState(93); ((Se_stmtContext)_localctx).properties = properties();
			...
			case 9:
				...
				{
				setState(98); match(KW_GET);
				setState(99); match(KW_NODE);
				setState(100); match(T__6);
				setState(101); ((Se_stmtContext)_localctx).obj_ids = obj_ids();
			...
			case 10:
				...
				{
				setState(106); match(KW_GET);
				setState(107); match(KW_LINK);
				setState(108); match(T__6);
				setState(109); ((Se_stmtContext)_localctx).obj_ids = obj_ids();
			...
			case 11:
				...
				{
				setState(114); match(KW_SET);
				setState(115); match(KW_NODE);
				setState(116); match(T__6);
				setState(117); ((Se_stmtContext)_localctx).obj_id = obj_id();
				setState(118); match(T__5);
				setState(119); match(T__2);
				setState(120); ((Se_stmtContext)_localctx).properties = properties();
			...
			case 12:
				...
				{
				setState(125); match(KW_SET);
				setState(126); match(KW_NODE);
				setState(127); match(T__6);
				setState(128); ((Se_stmtContext)_localctx).obj_id = obj_id();
				setState(129); match(T__1);
				setState(130); ((Se_stmtContext)_localctx).categorys = categorys();
				setState(131); match(T__5);
				setState(132); match(T__2);
				setState(133); ((Se_stmtContext)_localctx).properties = properties();
			...
			case 13:
				...
				{
				setState(138); match(KW_SET);
				setState(139); match(KW_LINK);
				setState(140); match(T__6);
				setState(141); ((Se_stmtContext)_localctx).obj_id = obj_id();
				setState(142); match(T__5);
				setState(143); match(T__2);
				setState(144); ((Se_stmtContext)_localctx).properties = properties();
			...
			case 14:
				...
				{
				setState(149); match(KW_SET);
				setState(150); match(KW_LINK);
				setState(151); match(T__6);
				setState(152); ((Se_stmtContext)_localctx).obj_id = obj_id();
				setState(153); match(T__1);
				setState(154); ((Se_stmtContext)_localctx).categorys = categorys();
				setState(155); match(T__5);
				setState(156); match(T__2);
				setState(157); ((Se_stmtContext)_localctx).properties = properties();
			...
			case 15:
				...
				{
				setState(162); match(KW_REMOVE);
				setState(163); match(KW_NODE);
				setState(164); match(T__6);
				setState(165); ((Se_stmtContext)_localctx).obj_ids = obj_ids();
			...
			case 16:
				...
				{
				setState(170); match(KW_REMOVE);
				setState(171); match(KW_LINK);
				setState(172); match(T__6);
				setState(173); ((Se_stmtContext)_localctx).obj_ids = obj_ids();
			...
			case 17:
				...
				{
				setState(178); match(KW_SHOW);
				setState(179); match(KW_NODE);
				setState(180); match(KW_TOP);
				setState(181); ((Se_stmtContext)_localctx).lt_numberic = lt_numberic();
				setState(182); end();
			...
			case 18:
				...
				{
				setState(185); match(KW_SHOW);
				setState(186); match(KW_LINK);
				setState(187); match(KW_TOP);
				setState(188); ((Se_stmtContext)_localctx).lt_numberic = lt_numberic();
				setState(189); end();
	...
	public final CategorysContext categorys() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(195); ((CategorysContext)_localctx).category = category();
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(198); ((CategorysContext)_localctx).category = category();
				setState(199); match(T__1);
				setState(200); ((CategorysContext)_localctx).categorys = categorys();

						String[] cats = new String[1 + _localctx.ret.length];
						cats[0] = ((CategorysContext)_localctx).category.ret;
						System.arraycopy(_localctx.ret, 0, cats, 1, _localctx.ret.length);
	...
	public final CategoryContext category() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(205); ((CategoryContext)_localctx).lt_string = lt_string();
	...
	public final PropertiesContext properties() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(209); ((PropertiesContext)_localctx).property = property();
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(212); ((PropertiesContext)_localctx).property = property();
				setState(213); match(T__1);
				setState(214); ((PropertiesContext)_localctx).properties = properties();

						propMap.put(((PropertiesContext)_localctx).property.key, ((PropertiesContext)_localctx).property.val);
						propMap.putAll(_localctx.ret);
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(219); ((PropertyContext)_localctx).property_key = property_key();
			setState(220); match(T__4);
			setState(221); ((PropertyContext)_localctx).property_val = property_val();
	...
	public final Property_keyContext property_key() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(224); ((Property_keyContext)_localctx).identifier = identifier();
	...
	public final Property_valContext property_val() throws RecognitionException {
		...
		try {
			...
			case NUMBERIC:
				enterOuterAlt(_localctx, 1);
				{
				setState(227); ((Property_valContext)_localctx).lt_numberic = lt_numberic();
			...
			case DECIMAL:
				enterOuterAlt(_localctx, 2);
				{
				setState(230); ((Property_valContext)_localctx).lt_decimal = lt_decimal();
			...
			case STRING:
				enterOuterAlt(_localctx, 3);
				{
				setState(233); ((Property_valContext)_localctx).lt_string = lt_string();
			...
			case BOOLEAN:
				enterOuterAlt(_localctx, 4);
				{
				setState(236); ((Property_valContext)_localctx).lt_boolean = lt_boolean();
	...
	public final Obj_idsContext obj_ids() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(241); ((Obj_idsContext)_localctx).obj_id = obj_id();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(244); ((Obj_idsContext)_localctx).obj_id = obj_id();
				setState(245); match(T__1);
				setState(246); ((Obj_idsContext)_localctx).obj_ids = obj_ids();

					int[] ids = new int[1 + _localctx.ret.length];
					ids[0] = ((Obj_idsContext)_localctx).obj_id.ret;
					System.arraycopy(_localctx.ret, 0, ids, 1, _localctx.ret.length);
	...
	public final Obj_idContext obj_id() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(251); ((Obj_idContext)_localctx).lt_numberic = lt_numberic();
	...
	public final HostContext host() throws RecognitionException {
		...
		try {
			...
			case IP:
				enterOuterAlt(_localctx, 1);
				{
				setState(254); ((HostContext)_localctx).IP = match(IP);
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 2);
				{
				setState(256); ((HostContext)_localctx).IDENTIFIER = match(IDENTIFIER);
	...
	public final PortContext port() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(260); ((PortContext)_localctx).lt_numberic = lt_numberic();
	...
	public final IdentifierContext identifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(263); ((IdentifierContext)_localctx).IDENTIFIER = match(IDENTIFIER);
	...
	public final Lt_numbericContext lt_numberic() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(269); ((Lt_numbericContext)_localctx).NUMBERIC = match(NUMBERIC);
	...
	public final Lt_decimalContext lt_decimal() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(272); ((Lt_decimalContext)_localctx).DECIMAL = match(DECIMAL);
	...
	public final Lt_stringContext lt_string() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(275); ((Lt_stringContext)_localctx).STRING = match(STRING);
	...
	public final Lt_booleanContext lt_boolean() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(278); ((Lt_booleanContext)_localctx).BOOLEAN = match(BOOLEAN);
	...
	public static final String _serializedATN =
		...
		" \"$&\2\2\u0124\2)\3\2\2\2\4-\3\2\2\2\6\u00c2\3\2\2\2\b\u00cd\3\2\2\2"+
		...
		"\61\u00c3\b\4\1\2\62\63\7\r\2\2\63\64\5\30\r\2\64\65\7\7\2\2\65\66\5\32"+
		"\16\2\66\67\5\36\20\2\678\b\4\1\28\u00c3\3\2\2\29:\7\r\2\2:;\5\30\r\2"+
		";<\7\7\2\2<=\5\32\16\2=>\7\4\2\2>?\5\34\17\2?@\7\3\2\2@A\5\34\17\2AB\5"+
		"\36\20\2BC\b\4\1\2C\u00c3\3\2\2\2DE\7\16\2\2E\u00c3\b\4\1\2FG\7\17\2\2"+
		"G\u00c3\b\4\1\2HI\7\f\2\2I\u00c3\b\4\1\2JK\7\20\2\2KL\7\25\2\2LM\7\5\2"+
		"\2MN\5\b\5\2NO\7\6\2\2OP\7\t\2\2PQ\5\f\7\2QR\7\13\2\2RS\5\36\20\2ST\b"+
		"\4\1\2T\u00c3\3\2\2\2UV\7\20\2\2VW\7\26\2\2WX\7\5\2\2XY\5\26\f\2YZ\7\n"+
		"\2\2Z[\5\26\f\2[\\\7\n\2\2\\]\5\b\5\2]^\7\6\2\2^_\7\t\2\2_`\5\f\7\2`a"+
		"\7\13\2\2ab\5\36\20\2bc\b\4\1\2c\u00c3\3\2\2\2de\7\21\2\2ef\7\25\2\2f"+
		"g\7\5\2\2gh\5\24\13\2hi\7\6\2\2ij\5\36\20\2jk\b\4\1\2k\u00c3\3\2\2\2l"+
		"m\7\21\2\2mn\7\26\2\2no\7\5\2\2op\5\24\13\2pq\7\6\2\2qr\5\36\20\2rs\b"+
		"\4\1\2s\u00c3\3\2\2\2tu\7\22\2\2uv\7\25\2\2vw\7\5\2\2wx\5\26\f\2xy\7\6"+
		"\2\2yz\7\t\2\2z{\5\f\7\2{|\7\13\2\2|}\5\36\20\2}~\b\4\1\2~\u00c3\3\2\2"+
		"\2\177\u0080\7\22\2\2\u0080\u0081\7\25\2\2\u0081\u0082\7\5\2\2\u0082\u0083"+
		"\5\26\f\2\u0083\u0084\7\n\2\2\u0084\u0085\5\b\5\2\u0085\u0086\7\6\2\2"+
		"\u0086\u0087\7\t\2\2\u0087\u0088\5\f\7\2\u0088\u0089\7\13\2\2\u0089\u008a"+
		"\5\36\20\2\u008a\u008b\b\4\1\2\u008b\u00c3\3\2\2\2\u008c\u008d\7\22\2"+
